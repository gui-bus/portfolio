...
import { ArrowUpRightIcon, CornersOutIcon, Icon, CodeIcon, PaintBrushIcon, LightningIcon, RocketLaunchIcon, StackIcon, ShieldCheckIcon, CpuIcon } from "@phosphor-icons/react";
...
function ModuleCorner() {
  return (
    <div className="absolute top-0 left-0 p-2 opacity-20 group-hover:opacity-100 transition-opacity">
      <CornersOutIcon size={12} weight="bold" className="text-blue-500" />
    </div>
  );
}

export function ServiceModuleClient({ cap, index, isLarge = false, ctaText }: ServiceModuleClientProps) {
