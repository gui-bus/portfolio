...
const TechSection = ({ id }: { id: string }) => {
  return (
    <section
      className="relative mx-auto flex h-full md:h-screen max-h-fit py-10 md:py-0 w-full max-w-6xl select-none flex-col items-center justify-center rounded-[3rem] bg-stone-100 md:max-h-[43rem]"
      id={id}
    >
